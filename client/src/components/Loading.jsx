...
export default function Loading() {
  return (
    <div className="border-[#4f4040] border-2 shadow rounded-md p-4 w-full max-w-xs sm:max-w-xl md:max-w-2xl lg:max-w-4xl  xl:max-w-6xl 2xl:max-w-xl mx-auto  bg-[#4f4040]">      
